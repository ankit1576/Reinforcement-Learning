...
https://github.com/user-attachments/assets/c6a2a441-48fd-4743-87c3-d71fda164526
...
2. **Reinforcement Learning (Q-Learning)**:
   ...
   - Each path is evaluated, and the agent is rewarded or penalized based on the length and outcome of the route taken.
     ...
     ![image](https://github.com/user-attachments/assets/be479a50-dd22-43ad-8a3f-d96c22cae3b9)
     fig:optimed path in blue colour using reinforcement learning
